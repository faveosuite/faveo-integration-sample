...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <p>All Agora Licenser settings for your application are stored in
...
<span class="nt">define</span>(<span class="s">"APL_ROOT_URL"</span>, <span class="s">"https://www.demo.phpmillion.com/apl"</span>);
...
//<span class="nt">define</span>(<span class="s">"APL_ROOT_NAMESERVERS"</span>, <span class="nt">array</span>(<span class="s">"ns1.phpmillion.com"</span>, <span class="s">"ns2.phpmillion.com"</span>)); <span class="nt">//ATTENTION</span>! <span class="nt">THIS</span> <span class="nt">FEATURE</span> <span class="nt">ONLY</span> <span class="nt">WORKS</span> <span class="nt">WITH</span> <span class="nt">PHP</span> <span class="nt">7.0</span> <span class="nt">AND</span> <span class="nt">HIGHER</span>, <span class="nt">ONLY</span> <span class="nt">UNCOMMENT</span> <span class="nt">THIS</span> <span class="nt">LINE</span> <span class="nt">IF</span> <span class="nt">PROTECTED</span> <span class="nt">SCRIPT</span> <span class="nt">WILL</span> <span class="nt">RUN</span> <span class="nt">ON</span> <span class="nt">COMPATIBLE</span> <span class="nt">SERVER</span>!
    ...
    While each option is explained in configuration file itself, the table below contains extra notes on the most important ones. All settings marked by * are required, while other settings are optional.
            ...
            <table class="table table-bordered bg-light">
                ...
                <tr>
                    ...
                    <td>Nameservers of your domain with AGORA LICENSE MANAGER installation (only works with domains and NOT subdomains). If nameservers are set, script will always check if <code>APL_ROOT_NAMESERVERS</code> match actual DNS records (very useful against users who may try blocking or nullrouting your domain on their servers). However, use it with caution because if nameservers of your domain are changed in future, old installations of protected script will stop working (you will need to update this file with new nameservers and send updated file to end user). Nameservers should be formatted as an array. For example: array("ns1.phpmillion.com", "ns2.phpmillion.com"). Nameservers are NOT CAse SensitIVE.</td>
